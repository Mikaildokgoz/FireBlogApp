...
export default function BlogCard({ item }) {
  ...
  return (
    ...
    >
      <CardMedia
        onClick={handleClick}
        style={{ width: "15rem", padding:'10px', display:'flex', textAlign:'center' }}
        component="img"
        image={item.url}
        alt="Paella dish"
      />
      ...
      <Typography style={{display:'flex', padding:'10px'}} > <AccountBoxIcon style={{color:'red', marginRight:'10px'}} /> {item.user}</Typography>
